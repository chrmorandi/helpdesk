...
class Mailbox extends Component
{
    ...
    protected function initMailPart(IncomingMail $mail, $partStructure, $partNum, $markAsSeen = true) {
        ...
        // attachments
        $attachmentId = ($partStructure->ifid && isset($partStructure->disposition) && in_array(strtolower($partStructure->disposition), ['attachment', 'inline']))
